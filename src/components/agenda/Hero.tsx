    ...
    <Container className="flex flex-col items-center gap-8 lg:gap-32 h-[1200px]">
        <div className="w-full flex justify-between flex-col md:flex-row h-full">
            <div className="w-full lg:w-[75%]">
                <span
                    className="font-inter font-extrabold text-xl tracking-[0.25em] text-negro-400"
                    >ENTERATE DE TODO</span>
                <h1
                    className="text-6xl lg:text-8xl 3xl:text-9xl font-bold font-tusker tracking-wide mt-4"
                >
                    NUESTRA AGENDA
                </h1>
                ...
                <div className="hidden md:flex items-center gap-2 mt-6">
                    ...
                    <div className=" w-[75%]">
                        <h2
                            className="text-[32px] font-inter font-bold text-white tracking-wider"
                        >
                            {featured.nombre}
                        </h2>
                        <p
                            className="text-[20px] font-normal font-ibm text-white/60"
                        >
        ...
        <div
            className="w-full md:flex-1 grid grid-cols-2 grid-rows-2 md:grid-cols-3 gap-x-4 gap-y-10 md:gap-y-10 h-[300px] md:h-full z-10"
        >
             {rest.map((event) => (
            <button
              key={event.id}
